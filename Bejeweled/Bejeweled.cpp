...
// Bejeweled.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CBejeweledApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CBejeweledApp::OnAppAbout)
...
// Construction de CBejeweledApp

CBejeweledApp::CBejeweledApp() noexcept
{
	...
	SetAppID(_T("Bejeweled.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CBejeweledApp

CBejeweledApp theApp;


// Initialisation de CBejeweledApp

BOOL CBejeweledApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CBejeweledDoc),
		RUNTIME_CLASS(CMainFrame),       // fenêtre frame SDI principale
		RUNTIME_CLASS(CBejeweledView));
	if (!pDocTemplate)
		return FALSE;
...
int CBejeweledApp::ExitInstance()
{
...
// gestionnaires de messages de CBejeweledApp
...
void CBejeweledApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CBejeweledApp

void CBejeweledApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CBejeweledApp::LoadCustomState()
{
}

void CBejeweledApp::SaveCustomState()
{
}
